 ...
 * MaisOpcoes.java
 *
 * Created on 12/06/2016, 15:52:30
 */
package Visão;
 ...
 */
public class MaisOpcoes extends javax.swing.JFrame {

    /** Creates new form MaisOpcoes */
    public MaisOpcoes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(130, 30, 170, 20);

        jButton2.setBackground(new java.awt.Color(255, 255, 255));
        jButton2.setText("Cria Boletim");
...
private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaisOpcoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new MaisOpcoes().setVisible(true);
            }
        });
    }
